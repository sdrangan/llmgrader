...
- **[Getting started](./gettingstarted/):  [what you need](./gettingstarted/requirements.md) to begin, and a [quickstart](./gettingstarted/quickstart.md) that gets the example course running on your laptop in about 15 minutes -- no Google Cloud, no deployment**
